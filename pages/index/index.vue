  ...
  <view>
    ...
    >
      ...
      <template v-slot:form-imgList>
        <upload-image
          ref="upload"
          :img-list.sync="formInfo.data.imgList"
          accept="jpg/png/jpeg"
          :auto-upload="false"
          :limit="3"
          :file-size="500"
...
import { iosProvinces, iosCitys, iosCountys } from "./areaData_v2";
    ...
    selecePicker() {
      ...
      this.$IosSelect(3, [iosProvinces, iosCitys, iosCountys], {
        ...
        callback: function(selectDataObj) {
          formInfoData.citys = `${selectDataObj.selectOneObj.value},${selectDataObj.selectTwoObj.value},${selectDataObj.selectThreeObj.value}`;
        }
      });
    },
